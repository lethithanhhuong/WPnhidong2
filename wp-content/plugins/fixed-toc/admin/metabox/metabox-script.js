...
(function($) {
  ...
  $(document).ready(function() {
    ...
    (function() {
      $('.ftoc-field-control').on('click', function() {
    ...
    (function() {
      ...
      toggleInner();
      onOffEle.on('change', toggleInner);
    ...
    (function() {
      ...
      var data = {
        ...
        location_fixed_position: {
          location_vertical_offset: {
            type: 'select',
            val: ['top-left', 'top-right', 'bottom-left', 'bottom-right'],
            increase: 1
          }
        },
        ...
        contents_display_in_post: {
          ...
          contents_width_in_post: {type: 'check', val: true, increase: 1},
      ...
      var control = {
        ...
        setFields: function() {
          ...
          $.each(data, function(triggerName, targets) {
            var $trigger = control.getTrigger(triggerName);
        ...
        getTrigger: function(triggerName) {
          return $('#tr_fixedtoc_meta_' + triggerName).
              children('td').
